      ...
      <div className="container relative mx-auto px-4 py-20 md:py-28">
        <div className="max-w-2xl">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <span className="inline-flex items-center rounded-full bg-amber-500/20 border border-amber-500/30 px-3 py-1 text-xs font-medium uppercase tracking-wide text-amber-200">
              Almoço de seg a sex · 11h30 às 15h
            </span>
          </div>
